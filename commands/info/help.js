...
module.exports = {
    ...
    .setColor("#f7f5f5")
    .setTitle("<a:nitroexe:717516241429987420> ***__Fun commands__***")
    ...
    .setColor("#000000")
    .setTitle("<:info:717791947292409926> ***__Info commands__***")
    ...
    .setColor("#f7f5f5")
    .setTitle("<:staff:717516241723457618> ***__Moderation commands__***")
...
//    .setImage("https://cdn.discordapp.com/avatars/291221132256870400/4f71fea454b62405b55f2fe0d8e7db0c.png?size=2048")
    .setDescription("If you need help with something feel free to join the [Cating Support](https://discord.gg/y4KHYZN)")
